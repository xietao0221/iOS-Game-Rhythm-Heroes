...
// System.Collections.Generic.Queue`1<BlockWrapper>[]
struct Queue_1U5BU5D_t3428488447  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) Queue_1_t2715171930 * m_Items[1];

public:
	inline Queue_1_t2715171930 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline Queue_1_t2715171930 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, Queue_1_t2715171930 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
